...
`order-platform/ground-truth.yaml` defines ten labeled changes. Every patch must apply independently to the clean baseline repository and is reserved as evidence for the Phase 2 Code Analyzer.
