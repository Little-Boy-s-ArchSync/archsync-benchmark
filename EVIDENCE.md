...
| case-06 | frontend-team | violation | relationship added | ARCH-001 | `frontend/src/app.ts:2` |
| case-07 | frontend-team | violation | relationship added | ARCH-002 | `frontend/src/app.ts:1` |
| case-08 | order-team | violation | relationship removed | ARCH-004 | `order-service/src/service.ts:1` |
| case-09 | order-team | evolution | component + relationship added | EVOLUTION-001 | `order-service/src/cache.ts:1` |
| case-10 | platform-team | evolution | components + relationships added | EVOLUTION-002 | `order-service/src/service.ts:1` |
...
The self-contained evidence subset (`node --test`, ground-truth, patch and integrity verification) also runs in [GitHub Actions](.github/workflows/evidence.yml) without credentials to another private repository.
