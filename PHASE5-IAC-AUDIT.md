...
commit `de11e48a8f69fbe5cd32f052489a323e1c81eab3`, preserving the existing Phase
1-3 Guardian dependency. `iac/guardian-source.json` pins the repository, draft
PR, full commit, contract version, tarball SHA-256, and package-content SHA-256.
